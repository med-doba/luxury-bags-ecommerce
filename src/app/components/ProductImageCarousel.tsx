    ...
    >
      ...
      <Image
        ...
        className={`object-cover object-center transition-all duration-1000 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] ${
          isHovered ? "scale-[1.015] brightness-105" : "scale-100 brightness-100"
      ...
      {hasMultipleImages && (
        <div className={`absolute bottom-3 left-1/2 transform -translate-x-1/2 flex space-x-2 z-10 transition-all duration-700 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] ${
          isHovered ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-3 scale-95"
        }`}>
      ...
      <div className={`absolute inset-0 transition-all duration-700 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] ${
        isHovered 
