...
// import { CartProvider }       <body className={inter.className} suppressHydrationWarning={true}>
...
import ClientHydrationWrapper from "@/app/components/ClientHydrationWrapper";
